...
use Sylius\PriceHistoryPlugin\Infrastructure\Serializer\ChannelPriceHistoryConfigDenormalizer as BaseDenormalizer;

class ChannelPriceConfigDenormalizer implements ContextAwareDenormalizerInterface, DenormalizerAwareInterface
{
