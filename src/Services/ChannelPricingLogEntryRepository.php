...
use Sylius\PriceHistoryPlugin\Infrastructure\Doctrine\ORM\ChannelPricingLogEntryRepository as BaseRepository;
use Webmozart\Assert\Assert;

class ChannelPricingLogEntryRepository extends BaseRepository
{
